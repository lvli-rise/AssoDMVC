...
class Net(nn.Module):
    def __init__(self, configs):
        ...
        self.FD_model = FDModel(configs['label_nums'], configs['view_classes'], configs['input_size'], configs['class_emb'], configs['class_emb'])
...
class AssoDMVC(nn.Module):
    ...
    def sym_conditional_prob(self, X_train, y_train, train_index):
        ...
        random.seed(42)
        k = 10
        length = int(len(X_train_flod['view1']) / k)
